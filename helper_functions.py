...
def save_L1_errors1(A_proj_estimate, true_A, output_filename, numdocs, seed_W, numwords, time):
    ...
    file.write("\t")
    file.write(
        str(min(greedy_error(true_A, A_proj_estimate), greedy_error(A_proj_estimate, true_A)))
    )
    file.write("\t")
...
# Appends greedy and min L1 errors between the true and recovered topic matrices to the given text file
def save_L1_errors(
    A_proj_estimate, true_A, output_filename, epsilon, numdocs, seed_W, numwords, time
):
...
# Appends greedy and min L1 errors between the true and recovered topic matrices to the given text file
def save_L1_errors2(
    A_proj_estimate, true_A, output_filename, epsilon, step, numdocs, seed_W, numwords, time
):
